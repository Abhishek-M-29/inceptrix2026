...
| Task | Guide |
|---|---|
| Vanilla HTML/JS embed | [frontend/doc/VANILLA_INTEGRATION.md](frontend/doc/VANILLA_INTEGRATION.md) |
| React / Next.js / Vue embed | [frontend/doc/REACT_INTEGRATION.md](frontend/doc/REACT_INTEGRATION.md) |
| Performance & mobile optimization | [frontend/doc/PERFORMANCE.md](frontend/doc/PERFORMANCE.md) |
| Debugging & common problems | [frontend/doc/COMMON_PROBLEMS.md](frontend/doc/COMMON_PROBLEMS.md) |

## Working Examples

| File | What it shows |
|---|---|
| [frontend/doc/vanilla-embed.html](frontend/doc/vanilla-embed.html) | Minimal vanilla JS embed with background + fallback |
| [frontend/doc/react-spline-wrapper.tsx](frontend/doc/react-spline-wrapper.tsx) | Production-ready lazy-loaded React wrapper with fallback |
| [frontend/doc/interactive-scene.tsx](frontend/doc/interactive-scene.tsx) | Full interactive example: events, object control, camera |
